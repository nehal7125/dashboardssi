...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-[17rem] flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full'
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-4 py-4.5 lg:py-4.5">
        <NavLink to="/dashboard">
          <div className="flex ml-1">
            <img
              src="/assets/imgs/safety.png" // Replace with your logo path
              alt="Logo"
              className="w-16 h-16"
            />
            <h1 className="text-3xl font-bold pl-2 text-white pt-4">SSI Admin</h1>
          </div>
        </NavLink>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-3 px-3 lg:mt-3 lg:px-2">
          {/* <!-- Menu Group --> */}
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/testing"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('testing') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              {/* <!-- Menu Item company Requests --> */}
              <SidebarLinkGroup
                activeCondition={pathname === '/company-management' || pathname.includes('company-management')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/company-management' || pathname.includes('company-management')) &&
                      ...
                      >
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <rect x="4" y="9" width="16" height="11" stroke="currentColor" strokeWidth="2" />
                          <rect x="6" y="12" width="4" height="4" stroke="currentColor" strokeWidth="2" />
                          <rect x="11" y="12" width="4" height="4" stroke="currentColor" strokeWidth="2" />
                          <rect x="16" y="12" width="4" height="4" stroke="currentColor" strokeWidth="2" />
                          <rect x="6" y="17" width="4" height="2" stroke="currentColor" strokeWidth="2" />
                          <rect x="11" y="17" width="4" height="2" stroke="currentColor" strokeWidth="2" />
                          <rect x="16" y="17" width="4" height="2" stroke="currentColor" strokeWidth="2" />
                          <path d="M4 9L12 3L20 9" stroke="currentColor" strokeWidth="2" />
                        </svg>
                        Technician
                        <svg
                          className={`absolute right-3 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'}`}
                          width="20"
                          height="20"
                          viewBox="0 0 20 20"
                          fill="none"
                      ...
                      <div className={`translate transform overflow-hidden ${!open && 'hidden'}`}>
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/company-management/company-details"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Technician Details
              ...
              {/* <!-- Menu Item company management --> */}

              {/* <!-- Menu Item customer management --> */}
              <SidebarLinkGroup
                activeCondition={pathname === '/customer-management' || pathname.includes('customer-management')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/customer-management' || pathname.includes('customer-management')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <path
                            d="M5.2 6.8C6.5539 6.8 7.8 5.5539 7.8 4.2C7.8 2.8461 6.5539 1.6 5.2 1.6C3.8461 1.6 2.6 2.8461 2.6 4.2C2.6 5.5539 3.8461 6.8 5.2 6.8Z"
                            stroke="currentColor"
                            strokeWidth="2"
                          />
                          <path
                            d="M18.8 6.8C20.1539 6.8 21.4 5.5539 21.4 4.2C21.4 2.8461 20.1539 1.6 18.8 1.6C17.4461 1.6 16.2 2.8461 16.2 4.2C16.2 5.5539 17.4461 6.8 18.8 6.8Z"
                            stroke="currentColor"
                            strokeWidth="2"
                          />
                          <path
                            d="M2 14C2 12.3431 3.34315 11 5 11H19C20.6569 11 22 12.3431 22 14V17C22 18.6569 20.6569 20 19 20H5C3.34315 20 2 18.6569 2 17V14Z"
                            stroke="currentColor"
                            strokeWidth="2"
                          />
                        </svg>
                      ...
                      <div className={`translate transform overflow-hidden ${!open && 'hidden'}`}>
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/customer-management/customer-profiles"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              <SidebarLinkGroup
                activeCondition={pathname === '/inventory-management' || pathname.includes('inventory-management')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/inventory-management' || pathname.includes('inventory-management')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <path d="M4 2H6V4H4V2Z" stroke="currentColor" strokeWidth="2" />
                          <path d="M4 6H6V8H4V6Z" stroke="currentColor" strokeWidth="2" />
                          <path d="M4 10H6V12H4V10Z" stroke="currentColor" strokeWidth="2" />
                          <path d="M10 14H20V18H10V14Z" stroke="currentColor" strokeWidth="2" />
                          <path d="M14 18H20V22H14V18Z" stroke="currentColor" strokeWidth="2" />
                          <path d="M4 14H6V16H4V14Z" stroke="currentColor" strokeWidth="2" />
                          <path d="M8 6H14V10H8V6Z" stroke="currentColor" strokeWidth="2" />
                        </svg>
                        Inventory
                        <svg
                          className={`absolute right-3 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'}`}
                      ...
                      <div className={`translate transform overflow-hidden ${!open && 'hidden'}`}>
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/inventory-management/equipment-types"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/inventory-management/part-types"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          {/* <li>
                            <NavLink
                              to="/inventory-management/stock-level"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/inventory-management/product-details"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          {/* <li>
                            <NavLink
                              to="/inventory-management/add-stock"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          {/* <li>
                            <NavLink
                              to="/inventory-management/add-product"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              {/* <!-- Menu Item Inspector management --> */}
              <SidebarLinkGroup
                activeCondition={pathname === '/inspector-management' || pathname.includes('inspector-management')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/inspector-management' || pathname.includes('inspector-management')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <path
                            d="M14.8284 14.8284L17 17M17 17L15.8284 18.8284M17 17L18.8284 15.1716"
                            stroke="currentColor"
                            strokeWidth="2"
                          />
                          <path
                            d="M6 8C6 6.34314 7.34314 5 9 5H15C16.6569 5 18 6.34314 18 8V10"
                            stroke="currentColor"
                            strokeWidth="2"
                          />
                          <path d="M14 19L20 13M20 13L18 11M20 13L22 16" stroke="currentColor" strokeWidth="2" />
                        </svg>
                        Inspector
                        <svg
                          className={`absolute right-3 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'}`}
                      ...
                      <div className={`translate transform overflow-hidden ${!open && 'hidden'}`}>
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/inspector-management/inspector-profiles"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          {/* <li>
                            <NavLink
                              to="/inspector-management/work-assignments"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          {/* <li>
                            <NavLink
                              to="/inspector-management/add-inspector"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-10 text-base font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              <SidebarLinkGroup
                activeCondition={pathname === '/EquipmentManagement' || pathname.includes('inspector-management')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/EquipmentManagement' || pathname.includes('inspector-management')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
              ...
              {/* <!-- Menu Item Reporting and analytics --> */}
              {/* <li>
                <NavLink
                  to="/reporting-analytics"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('reporting-analytics') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
                  ...
                  >
                    ...
                    />
                    <path
                      d="M16 12H20V18H16V12Z"
                      stroke="currentColor"
                      strokeWidth="2"
                    />
                    <path
                      d="M1 21L6 15L10 18L18 7L22 10"
                      stroke="currentColor"
                      strokeWidth="2"
                    />
                  </svg>
